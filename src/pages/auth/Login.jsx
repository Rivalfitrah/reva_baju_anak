...
>
    <div className="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full">
        ...
        <label className="block">
            ...
            <input type="email" placeholder="email" value={email} className="block w-full p-2 border border-gray-300 rounded-md mt-1" 
        ...
        <label className="block mt-3">
            ...
            <input type="password" placeholder="Password" value={password} className="block w-full p-2 border border-gray-300 rounded-md mt-1" 
        ...
        {/* Tombol Masuk */}
        <button type='submit' className="w-full bg-gradient-to-b from-[#FFE6C9] to bg-jambu text-black font-semibold py-2 mt-4 rounded-md">
            Masuk
        </button>
